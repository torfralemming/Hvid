...
import { ArrowLeft, Edit2, ArrowUpDown, Plus, X, RotateCw, Link as LinkIcon } from 'lucide-react';
import KeywordDialog from './KeywordDialog';
import PriceDialog from './PriceDialog';
import ProductSearchDialog from './ProductSearchDialog';
import ProductList from './ProductList';
import CategoryManagementDialog from './CategoryManagementDialog';
import CategoryUrlDialog from './CategoryUrlDialog';
...
function AdminDashboard() {
  ...
  const [showCategoryUrlDialog, setShowCategoryUrlDialog] = useState(false);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white py-12">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="flex gap-4">
              ...
              <button
                onClick={() => setShowCategoryUrlDialog(true)}
      ...
      <CategoryUrlDialog
        isOpen={showCategoryUrlDialog}
        onClose={() => setShowCategoryUrlDialog(false)}
